...
for kohta in lukumaarat:
    lukumaarat[kohta] = dict(sorted(lukumaarat[kohta].items(), key= lambda x: x[1], reverse= True))
    listana.append(sorted(lukumaarat[kohta].items(), key= lambda x: x[1], reverse= True))
